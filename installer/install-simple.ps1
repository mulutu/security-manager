...
# Main execution
if ($Help) {
    Write-Host "Security Manager - Simple Windows Installer" -ForegroundColor Green
    Write-Host ""
    Write-Host "Usage:" -ForegroundColor Yellow
    Write-Host "  irm https://raw.githubusercontent.com/mulutu/security-manager/main/installer/install-simple.ps1 | iex" -ForegroundColor White
    Write-Host "  irm https://raw.githubusercontent.com/mulutu/security-manager/main/installer/install-simple.ps1 | iex; Install-SM -Token 'your_token' -OrgId 'your_org'" -ForegroundColor White
    Write-Host ""
...
if (-NOT ([Security.Principal.WindowsPrincipal] [Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole] "Administrator")) {
    ...
    Write-Host "   3. Run: irm https://raw.githubusercontent.com/mulutu/security-manager/main/installer/install-simple.ps1 | iex" -ForegroundColor White
    Write-Host ""
    Write-Host "💡 Alternative: Use the full installer:" -ForegroundColor Yellow
    Write-Host "   irm https://raw.githubusercontent.com/mulutu/security-manager/main/installer/install.ps1 | iex" -ForegroundColor Cyan
    Write-Host ""
    exit 1
}
...
"@
    ...
    Write-Host "   3. Try the full installer: irm https://raw.githubusercontent.com/mulutu/security-manager/main/installer/install.ps1 | iex" -ForegroundColor White
